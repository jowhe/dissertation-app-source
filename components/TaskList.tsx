...
const TaskList = () => {
  return (
    <div className="container border rounded-lg lg:px-6 py-3 shadow-md dark:bg-neutral-900 mx-auto mt-3">
      <h1 className="text-3xl px-6 lg:px-0">Tasks</h1>
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell className='grid grid-cols-2 lg:grid-cols-3 grid-flow-row gap-2 xl:gap-7'>
